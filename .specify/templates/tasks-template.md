...
**Tests**: Include automated or manual validation tasks for every implementation
feature. Tests may be omitted only for documentation-only changes, and the
reason MUST be stated in the generated tasks.
...
- [ ] T011 [P] [US1] Contract/API validation for [endpoint] in [test path]
- [ ] T012 [P] [US1] Integration or manual validation for [user journey] in [test path or quickstart.md]
...
- [ ] TXXX Performance optimization only for measured problems
- [ ] TXXX [P] Additional unit tests (if requested) in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Manual MVP acceptance validation for completed feature order
