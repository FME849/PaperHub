...
export const env = {
  ...
  PASSWORD_RESET_TOKEN_TTL_MINUTES: optionalNumber("PASSWORD_RESET_TOKEN_TTL_MINUTES", 60),
  PASSWORD_RESET_MAX_SEND_RETRIES: optionalNumber("PASSWORD_RESET_MAX_SEND_RETRIES", 3),
  PASSWORD_RESET_RETRY_BACKOFF_MS: optionalNumber("PASSWORD_RESET_RETRY_BACKOFF_MS", 2000),
  PASSWORD_RESET_RATE_LIMIT_PER_EMAIL: optionalNumber("PASSWORD_RESET_RATE_LIMIT_PER_EMAIL", 5),
  PASSWORD_RESET_RATE_LIMIT_PER_IP: optionalNumber("PASSWORD_RESET_RATE_LIMIT_PER_IP", 15),
  PASSWORD_RESET_RATE_LIMIT_WINDOW_MS: optionalNumber("PASSWORD_RESET_RATE_LIMIT_WINDOW_MS", 900000),
} as const;
